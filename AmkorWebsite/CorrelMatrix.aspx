<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorrelMatrix.aspx.cs" Inherits="AmkorWebsite.CorrelMatrix" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Amkor | Correl Matrix</title>
...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="CorrelMatrix.aspx"><span>Correl Matrix</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <iframe id="iframe1" runat="server" style="width:100%" height="1000" src="excel/CorrelMatrix/CorrelMatrixHP93K.mht" >
      ...
      <div class="sidebar">
        <div class="gadget">
          <h2 class="star"><span>Correl</span> Matrix</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li>
            ...
            <li>
                <asp:Button ID="Button4" runat="server"  CssClass="Button12" Text="T2K EPP" onclick="Button4_Click" />
            </li>
              <li>
                <asp:Button ID="Button5" runat="server"  CssClass="Button12" Text="T2K HNT" onclick="Button5_Click" />
            </li>
          </ul>
        </div>
      </div>
