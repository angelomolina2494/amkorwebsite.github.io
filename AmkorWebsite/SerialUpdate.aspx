<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialUpdate.aspx.cs" Inherits="AmkorWebsite.SerialUpdate" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Amkor | Serial Update</title>
...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="SerialUpdate.aspx"><span>Serial Update</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
        <iframe src="excel/SerialUpdate.mht" width="100%" height="1000">
